...
(function() {
  ...
  // ========== DOTS GRID MENU ANIMATION ==========
  function initializeDotsGridMenu() {
    if (prefersReducedMotion || !initializeGSAP()) {
      return; 
    }
    ...
    menuBtn.addEventListener('click', () => {
      ...
      const anim = {
          open: () => { 
              gsap.to(dots[0], {x: 10, y: 10, scale: 1.2, ease: 'circleEase', duration: 0.5});
              gsap.to(dots[1], {opacity: 0, scale: 3, ease: 'circleEase', duration: 0.5});
              gsap.to(dots[2], {x: -10, y: 10, scale: 1.2, ease: 'circleEase', duration: 0.5});
              gsap.to(dots[3], {opacity: 0, scale: 3, ease: 'circleEase', duration: 0.5});
              gsap.to(dots[4], {scale: 1.3, ease: 'circleEase', duration: 0.5});
              gsap.to(dots[5], {opacity: 0, scale: 3, ease: 'circleEase', duration: 0.3});
              gsap.to(dots[6], {x: 10, y: -10, scale: 1.2, ease: 'circleEase', duration: 0.5});
              gsap.to(dots[7], {opacity: 0, scale: 3, ease: 'circleEase', duration: 0.5});
              gsap.to(dots[8], {x: -10, y: -10, scale: 1.2, ease: 'circleEase', duration: 0.5});
          },
          close: () => { 
